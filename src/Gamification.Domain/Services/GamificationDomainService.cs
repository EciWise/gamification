...
namespace Gamification.Domain.Services
{
    public class GamificationDomainService
    {
        ...
        public static PointTransaction AssignPoints(UserGamification user, GamificationRule rule, string idempotencyKey, Guid sourceEventId)
        {
        ...
        public static bool CheckLevelUp(UserGamification user, List<LevelDefinition> levels)
        {
            ...
            return nextLevel != null && nextLevel.Id != user.CurrentLevel.Id;
        }

        public static bool DetectLowRating(UserGamification user, decimal averageRating, decimal threshold = 3.5m)
        {
